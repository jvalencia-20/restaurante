    ...
    <Container4>
        ...
        <Minibox3>
          ...
          <div style={{justifyContent:"space-evenly",width:"9rem",display:"flex"}}>
            ...
            <a href="https://www.instagram.com/" target="_blank" rel="noreferrer"><FaInstagramSquare style={{fontSize:"32px", color:"#F5048B",borderRadius:"80px",background:"white"}}></FaInstagramSquare></a>
          </div>          
        </Minibox3>
      </Container4>
  </Background>
